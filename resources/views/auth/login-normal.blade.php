    ...
    <div class="mdl-grid portfolio-max-width portfolio-contact">
        <div class="mdl-cell mdl-cell--12-col mdl-card mdl-shadow--4dp">
            ...
            <div class="mdl-card__supporting-text">
                <p>
                    Login to make new votes, see if others agree with you.
                </p>
            </div>
            <div class="mdl-grid mdl-typography--text-center">
                <!-- facebook -->

                <div class="mdl-cell mdl-cell--6-col mdl-card mdl-shadow--4dp login-fb">
                    <a href="/redirect">
        ...
        <div class="mdl-grid">
            ...
            <a href="redirect"><img src="{{ asset('images/FB-f-Logo__blue_29.png') }}" style="height: 40px; width: 40px;"/></a>
                                <div class="mdl-layout-spacer"></div>
